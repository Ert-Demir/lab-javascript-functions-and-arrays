...
function averageWordLength() {
  const sum = wordsArr.reduce((acc, curr) => acc + curr.length, 0);
...
function uniquifyArray(wordsArray) {
  return wordsArray.reduce((acc, curr) => {
